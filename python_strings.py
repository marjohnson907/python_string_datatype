...
current_year_statement = "{} {} enjoyed celebrating {}."
print(current_year_statement.format(birth_year_statement.format(my_first_name,my_last_name,my_year_of_birth),my_first_name,current_year))
...
escape_last_name = '\t{} {}'
print(escape_last_name.format(my_last_name,my_year_of_birth))
